...
*
* Esse arquivo contŽm a implementa‹o da classe de entidade Usuario. Essa classe armazena as caracter’sticas
* de um usuario, que s‹o: nome, endereo, cep, cpf e senha.
*/

/**
* @brief Armazena uma estrutura de um Usu‡rio.
* @details Armazena as caracter’sticas de um usu‡rio, que s‹o: nome, endereo, cep, cpf e senha.
*/
